...
go install gopkg.in/jcmturner/gokrb5.v7/client@latest
go install gopkg.in/jcmturner/gokrb5.v7/config@latest
go install gopkg.in/jcmturner/gokrb5.v7/iana/etypeID@latest
go install gopkg.in/ldap.v2@latest
```
Then build it
